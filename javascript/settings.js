...
const majorList = ['건축학부', '건설환경공학과', '교통·물류공학과', '전자공학부', '배터리소재화학공학과', '기계공학과', '산업경영공학과', '로봇공학과', '에너지바이오학과', '융합시스템공학과', '스마트융합공학부', '컴퓨터학부', 'ICT융합학부', '인공지능학과', '수리데이터사이언스학과', '약학과', '차세대반도체융합공학부', '바이오신약융합학부', '국방지능정보융합학부', '글로벌문화통상학부', '광고홍보학과', '미디어학과', '문화인류학과', '문화콘텐츠학과', '경제학부', '경영학부', '보험계리학과', '회계세무학과', '주얼리·패션디자인학과', '영상디자인학과', '융합디자인학부', '스포츠과학부', '무용예술학과', '실용음악학과', 'LIONS자율전공학부', '재료화학공학과', '생명나노공학과', '융합공학과', '국방정보공학과', '응용물리학과', '의약생명과학과', '화학분자공학과', '해양융합공학과', '나노광전자학과', '한국언어문학과', '중국학과', '일본학과', '영미언어·문화학과', '프랑스학과', '정보사회미디어학과', '산업디자인학과', '커뮤니케이션디자인학과']
const pageList =  ["홈페이지", "포털", "LMS", "수강신청", "학사일정", "전자출결", "학생식당", "교직원식당", "푸드코트", "기숙사식당", "창업보육센터", "나의 단과대학", "나의 학과", "학술정보관", "HY-CDP", "오류 및 건의"];
